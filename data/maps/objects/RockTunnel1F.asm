	...
	const_export ROCKTUNNEL1F_JAW_FOSSIL
	const_export ROCKTUNNEL1F_SAIL_FOSSIL
...
RockTunnel1F_Object:
	...
	object_event  5, 18, SPRITE_HIKER, STAY, DOWN, TEXT_ROCKTUNNEL1F_HIKER2, OPP_HIKER, 13
	...
	object_event  3, 14, SPRITE_FOSSIL, STAY, NONE, TEXT_ROCKTUNNEL1F_JAW_FOSSIL, JAW_FOSSIL
	object_event 20, 20, SPRITE_FOSSIL, STAY, NONE, TEXT_ROCKTUNNEL1F_SAIL_FOSSIL, SAIL_FOSSIL
