	...
	const_export POKEMONTOWER4F_CARBOS
	const_export POKEMONTOWER4F_PP_UP
...
PokemonTower4F_Object:
	...
	object_event 12, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER4F_CARBOS, CARBOS
	object_event  9, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER4F_PP_UP, PP_UP
