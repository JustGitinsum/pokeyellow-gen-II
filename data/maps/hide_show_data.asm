...
; entries correspond to map ids
	...
	dw NoHS
	dw NoHS
	dw NoHS ;Route10FossilRoom ROUTE_10_FOSSIL_ROOM
	dw NoHS
	dw NoHS
	dw NoHS
	dw NoHS
...
Route4HS:
	db ROUTE_4, ROUTE4_TM_TWISTER, SHOW
Route9HS:
...
Route15HS:
	db ROUTE_15, ROUTE15_TM_NIGHT_SLASH, SHOW
Route16HS:
...
Route25HS:
	db ROUTE_25, ROUTE25_TM_PSYBEAM, SHOW
BluesHouseHS:
...
PokemonTower4FHS:
	db POKEMON_TOWER_4F, POKEMONTOWER4F_CARBOS,    SHOW
	db POKEMON_TOWER_4F, POKEMONTOWER4F_PP_UP, SHOW
...
RockTunnel1FHS:
	db ROCK_TUNNEL_1F, ROCKTUNNEL1F_JAW_FOSSIL,   SHOW
	db ROCK_TUNNEL_1F, ROCKTUNNEL1F_SAIL_FOSSIL,   SHOW
PowerPlantHS:
...
MtMoonB2FHS:
	...
	db MT_MOON_B2F, MTMOONB2F_TM_BRICK_BREAK, SHOW
SSAnne2FHS:
...
SSAnneB1FRoomsHS:
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_CALCIUM,      SHOW
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_MEGAHORN, SHOW
...
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_THUNDERBOLT,  SHOW
SafariZoneNorthHS:
...
SafariZoneWestHS:
	...
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_TM_ICE_BEAM, SHOW
