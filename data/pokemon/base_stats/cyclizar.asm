	...
	tmhm FORCE_PALM, 	SWORDS_DANCE,   TWISTER, 		AXE_KICK, 	    TOXIC, 		  \
		 ...
		 POISON_JAB, 	THUNDER_FANG, 	THUNDER, 	    IRON_HEAD, 		ACCELEROCK,   \
		 DRAGON_PULSE,  THUNDERBOLT, 	FIRE_BLAST, 	FLAMETHROWER,   DRAGON_CLAW,  \
		 ICE_FANG, 		THUNDER_WAVE,   FIRE_PUNCH, 	THUNDERPUNCH, 	STRENGTH
	; end
