	...
	; tm/hm learnset
	tmhm SWORDS_DANCE,  CLOSE_COMBAT, 	    TOXIC, 			MEGAHORN, 		FIRE_FANG, 	\	
		 BODY_SLAM, 	BUBBLEBEAM, 	TRAILBLAZE, 	HYPER_BEAM,     POISON_JAB, \
		 WATERFALL, 	ROCK_SLIDE, 	THUNDER_FANG, 	EARTHQUAKE, 	EARTH_POWER,\
		 DIG, 			IRON_HEAD, 		ACCELEROCK, 	PLAY_ROUGH, 	ICE_FANG, 	\
		 CUT, 			STRENGTH 
	; end
