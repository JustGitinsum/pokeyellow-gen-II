...
;MimicAnim:
;	battle_anim DARK_PULSE, SUBANIM_0_CIRCLES_1_SQUARES_CENTERING_ENEMY, 1, 6
;	battle_anim DARK_PULSE, SUBANIM_0_CIRCLE_1_SQUARE_TOSS_BACK, 1, 6
;	db -1 ; end
...
BeakBlastAnim:
	battle_anim MEGA_DRAIN, SE_LIGHT_SCREEN_PALETTE
	battle_anim BEAK_BLAST, SE_SQUISH_MON_PIC
	battle_anim NO_MOVE, SE_SHOOT_BALLS_UPWARD
	battle_anim HI_JUMP_KICK, SUBANIM_1_STAR_BIG_MOVING, 1, 6
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	battle_anim NO_MOVE, SE_SHOW_MON_PIC
...
ExplosionAnim:
	battle_anim EXPLOSION, SUBANIM_1_EXPLOSION, 1, 3
	db -1 ; end
