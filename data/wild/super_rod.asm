SuperRodFishingSlots::
	...
	db CERULEAN_CITY, FINIZEN, 25, FINIZEN, 30, PALAFIN, 30, PALAFIN, 40
	db VERMILION_CITY, TENTACOOL, 15, TENTACOOL, 20, TENTACOOL, 10, HORSEA, 5
	db CELADON_CITY, FINIZEN, 5, FINIZEN, 10, FINIZEN, 15, FINIZEN, 20
	...
	db ROUTE_4, FINIZEN, 20, FINIZEN, 25, FINIZEN, 30, PALAFIN, 30
	db ROUTE_6, FINIZEN, 5, FINIZEN, 10, FINIZEN, 15, FINIZEN, 20
	db ROUTE_24, FINIZEN, 20, FINIZEN, 25, FINIZEN, 30, PALAFIN, 30
	...
	db CERULEAN_CAVE_1F, FINIZEN, 25, PALAFIN, 35, PALAFIN, 45, PALAFIN, 55
	db CERULEAN_CAVE_B1F, FINIZEN, 30, PALAFIN, 40, PALAFIN, 50, PALAFIN, 60
	db -1 ; end
