...
; Route 19
	...
	db 29, GYARADOS, SHELLDER, SEAKING, 0
...
; Victory Road 2F
	db 41, BLISSEY, HYPNO, GOGOAT, RAICHU, 0
; Fuchsia Gym
...
; Route 13
	db 29, PIDGEY, PIDGEOTTO, 0
	db 25, SPEAROW, TORCHIC, PIDGEY, SPEAROW, SPEAROW, 0
...
; Viridian Gym
	db $FF, 50, NIDOKING, 53, PERSIAN, 53, NIDOQUEEN, 55, EXCADRILL, 55, GARCHOMP, 0
